...
import 'package:flutter_application_1/api%20integration/api%20integration%20using%20dio/views/detailData.dart';
  ...
  Center loadAnimation() {
    return Center(
      child: SizedBox(
        width: 150,
        height: 150,
        child: Lottie.asset("assets/animation/Animation - 1695986176169.json"),
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            width: 100,
            height: 100,
            child: Lottie.asset("assets/animation/Animation - 1695986500084.json"),
          ),
          MaterialButton(
